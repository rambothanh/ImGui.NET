    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            VeldridStartup.CreateWindowAndGraphicsDevice(
                new WindowCreateInfo(50, 50, 1280, 720, WindowState.Normal, "Thanh IAMGUI Demo"), //Khong dung duoc Unicode
            ...
            while (_window.Exists)
            {
                ...
                _controller.Update(1f / 60f, snapshot); // Feed the input events to our ImGui controller, which passes them through to ImGui.
                                                        //Cung cấp các sự kiện đầu vào cho bộ điều khiển ImGui của chúng tôi, bộ điều khiển này sẽ chuyển chúng đến ImGui.
        ...
        private static unsafe void SubmitUI()
        {
            ...
            //-----------------Tạo dự án mới và tạo window đầu tiên ở chỗ này, 
            //mấy chỗ khác cứ để đó để xem demo, xóa đi sau này
            // Create a window called "My First Tool", with a menu bar.

            {
                ImGui.Begin("Main Window");

                if (ImGui.Button("Button")) _showtext = !_showtext;

                if (_showtext)
                {
                    ImGui.Text("Xin chào, mình là Nguyen Trong Thành");
            ...
            // // // Mẹo: nếu chúng ta không gọi ImGui.BeginWindow () / ImGui.EndWindow (), các widget sẽ tự động xuất hiện trong cửa sổ có tên "Debug".
            // {
            //     ImGui.Text("Nguyễn Trọng Thành");
